                ...
                .subscribeSimple { event ->
                    ...
                    val eventData = EventRegistration(id = event.id.toString(), organization = null,
                            ...
                            userRegistration = event.status?.value
                                    ?: Event.Status.FINISHED, registrationHeadline = null, registrationSubtitle = null,
                        ...
                        compositeDisposable += eventRepository.getEventForm(
                                ...
                                .subscribeSimple { fields ->
                                    if (fields.data.isNotEmpty()) {
                                        val form = fields.data.firstOrNull { it.type == EventFormModel.Type.RATING }
                                        ...
                                        compositeDisposable += eventRepository.getEventFormResult(
                                                ...
                                                .subscribeSimple { fieldsResult ->
                                                    ...
                                                    viewState.apply {
                                                        ...
                                                        setFields(result.event, result.groupField, result.selectedGroup, result.groups, result.fieldsData, rating, files)
    ...
    override fun onSendClick() {
        compositeDisposable += Single.fromCallable {
            ...
            MultipartBody.Builder()
                ...
                .flatMap { /*eventRepository.setEventRating(eventId, it)*/eventRepository.eventRegisterNew(it) }
                .withCheckInternetConnectivity()
                .performOnBackgroundOutOnMain()
                .withLoadingDialog(viewState)
                .subscribeSimple(
    ...
    override fun onAddFileClick(field: EventRegisterFieldData<EventFile?>) {
        ...
        compositeDisposable += rxPermissions.request(Manifest.permission.READ_EXTERNAL_STORAGE)
                ...
                .subscribeSimple(
                    ...
                    val availableExtensions = field.field.values ?: /*emptyList()*/listOf("jpg", "jpeg")
