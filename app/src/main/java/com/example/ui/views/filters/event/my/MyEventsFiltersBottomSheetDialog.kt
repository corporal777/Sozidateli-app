...
import com.example.app.databinding.BottomSheetMyEventFiltersBinding
...
class MyEventsFiltersBottomSheetDialog(
    context: Context,
    filter: SearchFilter.EventNew
) : BottomSheetDialog(context), MyEventsFiltersBottomSheetContract.View {

    private val mBinding = BottomSheetMyEventFiltersBinding.inflate(LayoutInflater.from(context))
    ...
    @InjectPresenter
    lateinit var presenter: MyEventsFiltersBottomSheetPresenter

    @Inject
    lateinit var presenterProvider: Provider<MyEventsFiltersBottomSheetPresenter>

    @ProvidePresenter
    fun providePresenter(): MyEventsFiltersBottomSheetPresenter = presenterProvider.get()
    ...
    fun setFiltersSelected(block: (filters: SearchFilter.EventNew) -> Unit): MyEventsFiltersBottomSheetDialog {
