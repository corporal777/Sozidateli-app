...
class PasswordCustomView: FrameLayout {
    ...
    fun setHyperlinkClickCallback(block: () -> Unit): PasswordCustomView {
        onClickAgreeHyperlink = block
        return this
    }

    fun setChangedSelectionCallback(block: (isChecked: Boolean) -> Unit): PasswordCustomView {
        onAgreeChangedSelection = block
        return this
    }

    fun setPasswordValidCallback(block: (password: PasswordModel) -> Unit): PasswordCustomView {
