...
) : BaseNotificationTypePresenter<ProjectNotificationsContract.View>(appData, userRepository, notificationManager, socket), ProjectNotificationsContract.Presenter {
