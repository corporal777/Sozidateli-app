...
@Inject constructor(
...
) : BasePresenter<ChatContractNew.View>(appData), ChatContractNew.Presenter {
    ...
    override fun attachView(view: ChatContractNew.View?) {
    ...
    override fun detachView(view: ChatContractNew.View?) {
        view?.hideKeyboard()
