...
class PartnerFragment : BaseFragment(), PartnerContract.View {
    ...
    override fun setData(partner: Partner) {
        Picasso.get().load(partner.logo.let { if(it.isNullOrEmpty()) null else it }).placeholder(R.drawable.ic_launcher_background).into(ivLogo)
