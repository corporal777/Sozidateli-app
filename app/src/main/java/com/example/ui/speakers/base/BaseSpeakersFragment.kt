...
abstract class BaseSpeakersFragment : BaseFragment(), BaseSpeakersContract.View {
    ...
    protected val adapter: SimplePagingRecyclerViewAdapter<Speaker> by lazy {
            ...
            override fun onBindItem(viewHolder: ViewHolder, item: Speaker?, position: Int) {
                ...
                viewHolder.apply {
                    ...
                    btnSubscribe.apply {
                        ...
                        setOnClickListener { onSpeakerFavoriteChangeClick(item) }
                    }

                    itemView.setOnClickListener { onSpeakerClick(item) }
                }
            }
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.apply {
            adapter = this@BaseSpeakersFragment.adapter
