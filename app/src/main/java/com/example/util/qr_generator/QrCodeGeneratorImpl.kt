...
import com.example.util.qr_generator.encoder.QrCodeMatrix
import com.example.util.qr_generator.encoder.QrEncoder
import com.example.util.qr_generator.encoder.QrRenderResult
import com.example.util.qr_generator.style.EmptyDrawable
import com.example.util.qr_generator.style.Neighbors
import com.example.util.qr_generator.style.QrColor
import com.example.util.qr_generator.style.QrColorSeparatePixels
...
private val QrOptions.actualEcl : QrErrorCorrectionLevel
    get() = if (errorCorrectionLevel == QrErrorCorrectionLevel.Auto) when {
        ...
        logo.size * (1 + logo.padding.value) in .2 .. .3 && errorCorrectionLevel.lvl < ErrorCorrectionLevel.Q -> {
