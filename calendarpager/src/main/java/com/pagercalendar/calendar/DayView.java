...
import static com.pagercalendar.calendar.MaterialCalendarView.showDecoratedDisabled;
import static com.pagercalendar.calendar.MaterialCalendarView.showOtherMonths;
import static com.pagercalendar.calendar.MaterialCalendarView.showOutOfRange;
...
import com.pagercalendar.calendar.format.DayFormatter;
...
//        setPadding(0,0,0, padding);
        ...
        if (weekDay == DayOfWeek.SATURDAY || weekDay == DayOfWeek.SUNDAY) {
            ...
            setTextAppearance(getContext(), R.style.TextAppearance_MaterialCalendarWidget_Date);
        }
    }
    ...
    void applyColors() {
        DayOfWeek weekDay = date.getDate().getDayOfWeek();
        if (weekDay == DayOfWeek.SATURDAY || weekDay == DayOfWeek.SUNDAY) {
