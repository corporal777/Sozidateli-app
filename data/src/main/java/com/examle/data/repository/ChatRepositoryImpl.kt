...
//
//    override fun createChat(body: com.examle.data.bodies.CreateChatBody): Single<CreatedChatModel> =
//        api.createChat(body)
//
...
//        }
//
//    override fun chatBann(body: com.examle.data.bodies.CreateChatBody): Single<BannedUsersModel> =
//        api.chatBan(body)
//
