...
import com.examle.data.bodies.ApproveBody
import com.examle.data.bodies.BindSocialAccountBody
import com.examle.data.bodies.CancelBody
import com.examle.data.bodies.ConfirmCodeBody
import com.examle.data.bodies.CreateChatBody
import com.examle.data.bodies.DeclineBody
import com.examle.data.bodies.EmailCodeBody
import com.examle.data.bodies.EventCalendarBody
import com.examle.data.bodies.FcmTokenBody
import com.examle.data.bodies.MessageBodyNew
import com.examle.data.bodies.MessageToEventBody
import com.examle.data.bodies.PasswordBody
import com.examle.data.bodies.QrBody
import com.examle.data.bodies.RebaseInviteBody
import com.examle.data.bodies.RecoverPasswordBody
import com.examle.data.bodies.RecoverPasswordResponse
import com.examle.data.bodies.RegisterBody
import com.examle.data.bodies.RegisterToEventBody
import com.examle.data.bodies.SnRegisterBody
import com.examle.data.bodies.VKAuthBody
import com.examle.data.models.AcademicDegreeBodyModel
import com.examle.data.models.AddFavoriteModel
import com.examle.data.models.AddTempFavoriteModel
import com.examle.data.models.ApiNewResponse
import com.examle.data.models.AppUpdateModel
import com.examle.data.models.AuthResponse
import com.examle.data.models.BannedUsersModel
import com.examle.data.models.ChatModel
import com.examle.data.models.CreatedChatModel
import com.examle.data.models.EducationBodyModel
import com.examle.data.models.EducationLevelModel
import com.examle.data.models.EventActivityModel
import com.examle.data.models.EventCalendarModel
import com.examle.data.models.EventFavoriteModel
import com.examle.data.models.EventFormModel
import com.examle.data.models.EventFormResultDraftModel
import com.examle.data.models.EventFormResultModel
import com.examle.data.models.EventFormatsModel
import com.examle.data.models.EventListResponse
import com.examle.data.models.EventRegisterProfilePrefilledData
import com.examle.data.models.EventResponse
import com.examle.data.models.EventSubscriptionRequest
import com.examle.data.models.EventTagModel
import com.examle.data.models.FavoriteModel
import com.examle.data.models.ImageModel
import com.examle.data.models.ImageResponse
import com.examle.data.models.InterestsModel
import com.examle.data.models.InviteDetail
import com.examle.data.models.MemberModel
import com.examle.data.models.MessageModel
import com.examle.data.models.NotificationModel
import com.examle.data.models.OrganizationMemberModel
import com.examle.data.models.OrganizationNew
import com.examle.data.models.PageModel
import com.examle.data.models.PartnerModel
import com.examle.data.models.QrAuthResponse
import com.examle.data.models.RegistrationAgreementStatus
import com.examle.data.models.SearchAddressModel
import com.examle.data.models.SearchDataNew
import com.examle.data.models.SearchResponseData
import com.examle.data.models.SearchTown
import com.examle.data.models.SnAuthResponse
import com.examle.data.models.SnBindDataModel
import com.examle.data.models.SupportData
import com.examle.data.models.TempAuthResponse
import com.examle.data.models.UnacceptedInviteNotification
import com.examle.data.models.UserDetail
import com.examle.data.models.UserFiles
import com.examle.data.models.UserProfileFieldsModel
import com.examle.data.models.UserSessions
import com.examle.data.models.UsersFavoriteModel
import com.examle.data.models.WorkExperienceServerModel
...
interface Api {
    ...
    suspend fun getTokenStatus(): TokenStatusModel
    ...
    //+
    @GET("v1/event")
    fun getEvents(@QueryMap map: Map<String, Any>): Maybe<EventListResponse>

    //+
    @GET("v1/event/event-list")
    fun getEventsList(@QueryMap map: Map<String, Any>): Deferred<EventListResponse>

    //+
    @GET("v1/event/event-list")
    fun getOrganizationEventsList(@QueryMap map: Map<String, Any>): Maybe<EventListResponse>

    //+
    @GET("v1/event/sorted")
    fun getSortedEventsList(@QueryMap map: Map<String, Any>): Maybe<EventListResponse>

    //+
    @GET("v1/user-calendar/events")
    fun getUserCalendarEvents(@Query("binds") binds: String): Maybe<ApiNewResponse<List<EventResponse>>>
    ...
    //+
    @GET("v1/event/{id}")
    fun getEventDetails(@Path("id") eventId: String, @Query("binds") binds: String): Maybe<EventResponse>

    @GET("v1/event/{id}")
    suspend fun getEventDetailsNew(@Path("id") eventId: String, @Query("binds") binds: String): EventResponse
    ...
    @POST("v1/event-user-registration/{id}/register")
    suspend fun registerEvent(@Path("id") id: Int, @Body body: RegisterToEventBody)

    @PATCH("v1/event-user-registration/{id}/cancel")
    fun cancelRegisterToEvent(@Path("id") id: Int): Completable

    @PATCH("v1/event-user-registration/{id}/cancel")
    suspend fun cancelRegisterEvent(@Path("id") id: Int)
    ...
    @PATCH("v1/event-agreement/{id}")
    suspend fun acceptEventAgreement(@Path("id") id: Int): RegistrationAgreementStatus
