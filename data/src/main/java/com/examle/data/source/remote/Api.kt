...
import com.examle.data.models.auth.AuthResponse
import com.examle.data.models.auth.QrAuthResponse
import com.examle.data.models.auth.SnAuthResponse
import com.examle.data.models.auth.TempAuthResponse
...
import com.examle.data.models.event.EventTagModel
...
import com.examle.domain.model.body.FcmTokenBody
...
interface Api {
    ...
    //+
    @GET("v1/event/{id}")
    suspend fun getEventDetails(@Path("id") eventId: String, @Query("binds") binds: String): EventResponse
    ...
    suspend fun rebaseInvite(@Path("id") id: Int, @Body body: InviteBody)
