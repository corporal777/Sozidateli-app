...
import com.examle.data.models.EventFormat
import com.examle.data.models.EventSubscriptionResponse
import com.examle.data.models.FileModel
import com.examle.data.models.ImageModel
import com.examle.data.models.MapInfo
...
import com.examle.data.models.Place
...
data class EventResponse(
    ...
    val status: EventsStatusResponse,
...
data class EventBindsModel(
    ...
    var currentUserRegistration: CurrentUserRegistrationResponse? = null,
    @SerializedName("current-user-registration-state")
    var currentUserRegistrationState: EventRegistrationStateResponse? = null,
    @SerializedName("user-form-result")
    val userFormResult: List<UserFormResultModel>? = null,
    @SerializedName("eventRegistrationState")
    val eventRegistrationState: EventRegistrationStateResponse? = null,
