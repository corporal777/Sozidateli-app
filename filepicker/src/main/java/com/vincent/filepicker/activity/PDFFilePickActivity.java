...
public class PDFFilePickActivity extends BaseActivity {
    ...
    private void initView() {
       ...
       // tv_count.setText(mCurrentNumber + "/" + mMaxNumber);
        ...
        ((TextView)findViewById(R.id.tvTitle)).setText(R.string.select_pdf);
    ...
    private void onSelected(NormalFile file){
        Intent intent = new Intent();
        intent.putExtra(Constant.RESULT_PICK_FILE, file);
        setResult(RESULT_OK, intent);
        finish();
    }
